...
public class CmdTheCrewAcceptTask extends Subcommand {

	// /thecrew accepttask [#]
	public CmdTheCrewAcceptTask(String key, String desc, String perm, SubcommandRunner runner) {
	...
	public void run(CommandSource s, String[] args) {
		...
		inst.acceptTask(p, Integer.parseInt(args[0]));
	}
